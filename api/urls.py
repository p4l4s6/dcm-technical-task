...
from .views import TestRunRequestAPIView, TestRunRequestItemAPIView, AssetsAPIView, UploadTestCase
...
urlpatterns = [
    ...
    path('upload', UploadTestCase.as_view(), name='upload_test_case'),
]
